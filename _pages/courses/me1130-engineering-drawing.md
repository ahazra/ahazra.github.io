---
layout: single
title: "ME 1130: Engineering Drawing"
permalink: /courses/me1130-engineering-drawing/
author_profile: true
---
...
<p class="course-meta">Undergraduate · offered 2023</p>

## Course Materials

{% assign data = site.data.courses.me1130-engineering-drawing %}
{% if data.materials and data.materials.size > 0 %}
<ul>
{% for item in data.materials %}
  <li><a href="{{ '/assets/courses/me1130-engineering-drawing/' | append: item.file | relative_url }}">{{ item.title }}</a></li>
{% endfor %}
</ul>
{% else %}
