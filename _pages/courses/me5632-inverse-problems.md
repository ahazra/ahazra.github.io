---
layout: single
title: "ME 5632: Computational Methods for Inverse Problems"
permalink: /courses/me5632-inverse-problems/
author_profile: true
---
...
<p class="course-meta">Graduate · offered 2024, 2026</p>

## Course Materials

{% assign data = site.data.courses.me5632-inverse-problems %}
{% if data.materials and data.materials.size > 0 %}
<ul>
{% for item in data.materials %}
  <li><a href="{{ '/assets/courses/me5632-inverse-problems/' | append: item.file | relative_url }}">{{ item.title }}</a></li>
{% endfor %}
</ul>
{% else %}
